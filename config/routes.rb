...
Madek::Application.routes.draw do
  ...
  get 'vocabulary/:meta_key_id/term/*term', constraints: { meta_key_id: /.*:[^:\/]*/ },
    to: 'keywords#redirect_by_term', as: 'vocabulary_meta_key_term_redirect', format: false

  get 'vocabulary/:meta_key_id/terms/:keyword_id', constraints: { meta_key_id: /.*:[^:\/]*/ },
    to: 'keywords#show', as: 'vocabulary_meta_key_term'
