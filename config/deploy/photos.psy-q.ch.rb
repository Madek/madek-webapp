...
set :application, "photos.psy-q.ch"
...
set :deploy_to, "/home/web/photos.psy-q.ch"

# If you aren't using Subversion to manage your source code, specify
# your SCM below:
# set :scm, :subversion

role :app, "photos@www.psy-q.ch"
role :web, "photos@www.psy-q.ch"
role :db,  "photos@www.psy-q.ch", :primary => true
