...
task :configure_environment do
  ...
  run "sed -i 's:VIDEO_ENCODING_BASE_URL = \"http://test:MAdeK@test.madek.zhdk.ch\":VIDEO_ENCODING_BASE_URL = \"http://demo.medienarchiv.zhdk.ch\":' #{release_path}/config/application.rb"
end
