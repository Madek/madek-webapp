...
set :custom_config_css, "/home/madek/_custom_config.css.sass"
set :checkout, :export
...
role :app, "madek@195.176.254.32"
role :web, "madek@195.176.254.32"
role :db,  "madek@195.176.254.32", :primary => true
...
task :configure_environment do
  ...
  run "sed -i 's,ENCODING_BASE_URL.*,ENCODING_BASE_URL = \"http://madek-test.zhdk.ch\",'  #{release_path}/config/application.rb"
