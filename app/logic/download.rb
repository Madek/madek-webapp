...
#####################################################################################################################
      ...
      unless params['id'].blank? 
        ...
        unless @media_entry.nil?
          ...
          if is_preview
            return [500, {"Content-Type" => "text/html"}, ["Sie haben nicht die notwendige Zugriffsberechtigung."]] unless Permissions.authorized?(current_user, :view, @media_entry) 
            ...
            return [500, {"Content-Type" => "text/html"}, ["Sie haben nicht die notwendige Zugriffsberechtigung."]] unless Permissions.authorized?(current_user, :download, @media_entry) 
          end
