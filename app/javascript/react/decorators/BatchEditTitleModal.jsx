        ...
        <RailsForm name="batch_edit_title" action={submitUrl} method="put" authToken={authToken}>
          ...
          <div className="ui-modal-body" style={{ maxHeight: 'none' }}>
            ...
            {!loading && !errorMessage && (
              <table className="ui-table borderless" style={{ width: '100%' }}>
                    ...
                    <tr key={entry.id}>
                      ...
                      {/* <td className="pls" style={{ width: '25%' }}>
                        ...
                        {entry.is_draft && entry.can_be_published && (
                          <span>
                            {t('batch_edit_title_status_complete')}
                            <Icon
                              i="checkmark"
                              style={{ marginLeft: '4px', position: 'relative', top: '2px' }}
                              title={t('batch_edit_title_info_will_autopublish')}
                            />
                          </span>
                        )}
                        {entry.is_draft && !entry.can_be_published && (
                          <span>
                            {t('batch_edit_title_status_incomplete')}
                            <Icon
                              i="bang"
                              style={{ marginLeft: '4px', position: 'relative', top: '2px' }}
                              title={t('batch_edit_title_info_wont_autopublish')}
                            />
                          </span>
                        )}
                      </td> */}
