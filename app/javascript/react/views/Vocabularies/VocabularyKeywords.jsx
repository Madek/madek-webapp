...
const MetakeyItem = ({ meta_key, keywords }) => {
  const sortLabel = meta_key.alphabetical_order
    ? t('meta_key_order_alphabetical')
    : t('meta_key_order_custom')
  const sortTitle = meta_key.alphabetical_order
    ? t('meta_key_order_alphabetical_hint')
    : t('meta_key_order_custom_hint')
...
const VocabularyKeywords = ({ get, for_url }) => {
