...
setup = ->
  $(".item_box.set:not(.popup_target):not(.inspected) .thumb_box_set").live "mouseenter", -> enter_target $(this)
  $(".item_box.set.popup_target:not(.popup):not(.inspected) .thumb_box_set").live "mouseenter", -> enter_target $(this)
  $(".item_box.set:not(.popup_target):not(.inspected) .thumb_box_set").live "click", -> stop_target_popup $(this)
  $(".item_box.set:not(.popup):not(.inspected) .thumb_box_set").live "mouseleave", -> leave_target $(this)
