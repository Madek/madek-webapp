...
module.exports = React.createClass
  ...
  render: ({resourceType, imageUrl, mediaType, title, subtitle, mediaUrl, metaData, selectProps, favoriteProps, deleteProps, get} = @props) ->
    ...
    if get.list_meta_data
      ...
      if relation_counts.parent_collections_count != undefined
        usageData.list.push({
          key: 'parents',
          type: 'text',
      ...
      if relation_counts.child_collections_count != undefined && relation_counts.child_media_entries_count != undefined
        usageData.list.push({
          key: 'children',
          type: 'text',
