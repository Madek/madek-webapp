    ...
    <div className='bright ui-container pal rounded'>
      ...
      <RailsForm ref='form'
        ...
        <div style={@_displayBlockIf(!@state.selectedUser)}>
          <AutoComplete
            existingCallback={(value) => value.uuid == @props.responsibleUuid}
            className='block'
            ...
            <tr>
              <td style={{textAlign: 'right'}}>
                {t('transfer_responsibility_permission_view')} <input type='checkbox'
                  ...
                  checked={@state.permissionLevel >= 1} onChange={f.curry(@_onToggleCheckbox)(1)} />
              </td>
              {
