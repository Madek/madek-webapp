module Modules
  module CustomUrls
    ...
    def shared_custom_urls(resource)
    ...
    def shared_edit_custom_urls(resource)
      auth_authorize(resource)
    ...
    def shared_set_primary_custom_url(resource)
      auth_authorize(resource)
    ...
    def shared_update_custom_urls(user, resource)
      auth_authorize(resource)
