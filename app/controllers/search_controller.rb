...
=begin
  ...
  def show
    ...
    @_media_entry_ids = viewable_media_entry_ids #-# (search_result & viewable_media_entry_ids)
    ...
    @_media_set_ids = viewable_media_set_ids #-# (search_result & viewable_media_set_ids)
    ...
    #-# search_result = Media::Set.search_for_ids(params[:query], search_options)
    @_media_project_ids = viewable_media_set_ids #-# (search_result & viewable_media_set_ids)
