...
feature 'Batch dropdown' do
  ...
  scenario 'Check dropdown menu and highlighting according to selection' do
    ...
    check_full_dropdown(
      ...
      media_entries_edit_title: { count: 3, highlights: media_entries_1_2_3 },
    ...
    check_full_dropdown(
      ...
      media_entries_edit_title: { count: 2, highlights: media_entries_1_3 },
    ...
    check_full_dropdown(
      ...
      media_entries_edit_title: { count: 0, active: false, highlights: [] },
