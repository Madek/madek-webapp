Feature: import images and manage media entries based on images
  ...
  @javascript
  Scenario: import an image file for another user to see
    When I import the file "features/data/images/berlin_wall_01.jpg" relative to the Rails directory
     And I go to the import edit
  ...
  @javascript
  Scenario: import an image file for my group to see
    Given a group called "Mauerfäller" exists
      ...
      And I am "normin"
      And I import the file "features/data/images/berlin_wall_01.jpg" relative to the Rails directory
      And I go to the import edit
      And I fill in the metadata for entry number 1 as follows:
      | label     | value                             |
  ...
  @javascript
  Scenario: import an image that has MAdeK title and date information (specific date) its EXIF/IPTC metadata
    When I import the file "features/data/images/date_should_be_2011-05-30.jpg" relative to the Rails directory
     And I go to the import edit
     And I follow "weiter..."
     And I wait for the CSS element ".has-set-widget"
     And I follow "Import abschliessen"
  ...
  @poltergeist 
  Scenario: import an image that has MAdeK metadata with a from/to date in its EXIF/IPTC metadata
    When I import the file "features/data/images/date_should_be_from_to_may.jpg" relative to the Rails directory
     And I go to the import edit
     And I follow "weiter..."
     And I wait for the CSS element ".has-set-widget"
     And I follow "Import abschliessen"
  ...
  @poltergeist 
  Scenario: import an image that has MAdeK metadata with a string instead of a date its EXIF/IPTC metadata
    When I import the file "features/data/images/date_should_be_1990.jpg" relative to the Rails directory
     And I go to the import edit
     And I follow "weiter..."
     And I wait for the CSS element ".has-set-widget"
     And I follow "Import abschliessen"
