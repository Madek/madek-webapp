Feature: Possibility to see entries and sets according to permissions

  In order to be able to see entries and sets 
  As a normal user
  I want to be able to see entries and sets (resources) when i got to the application
  ...
  @poltergeist
  Scenario: Max goes to the dashboard and wants to see his own media entries and public media entries from other users
    Given I am "max"
  ...
  @poltergeist
  Scenario: Moritz goes to the my con and wants to see his own media entries and public media entries from other users
    Given I am "moritz"
    When I go to the home page
