...
Then /^I can choose to continue to a list of all my content$/ do
	all(".media_resources.index.grid")[0].find(".buttons").text.should == "Alle meine Inhalte"
end
...
Then /^I can choose to continue to a list of all content assigned to me$/ do
	all(".media_resources.index.grid")[1].find(".buttons").text.should == "Alle mir anvertrauten Inhalte"
end
...
Then /^I can choose to continue to a list of all content available to the public$/ do
	all(".media_resources.index.grid")[2].find(".buttons").text.should == "Alle öffentlichen Inhalte"
end
