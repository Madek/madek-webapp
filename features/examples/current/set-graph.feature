Feature: Set Graph
  ...
  Scenario: What i see in the set graph itself
    ...
    Then I see the realtionship between my sets
     And I see a zoom panel
     And I see a navigation panel (up, down, left, right)
