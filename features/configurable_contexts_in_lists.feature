Feature: Setting and displaying configurable contexts in list views
  ...
  Scenario:  Setting and displaying configurable contexts in list views
    ...
    And I set the input with the name "app_settings[second_displayed_context_id]" to "Institution"
    And I submit
    When I visit the "/app_admin/settings/third_displayed_context_id/edit" path
    And I set the input with the name "app_settings[third_displayed_context_id]" to "Landschaftsvisualisierung"
    And I submit
