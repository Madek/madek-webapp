...
|---|---|---|
| `app/javascript/application.js` | `bundle.js` | `dev-bundle.js` |
| `app/javascript/embedded-view.js` | `bundle-embedded-view.js` | `dev-bundle-embedded-view.js` |
| `app/javascript/integration-testbed.js` | `bundle-integration-testbed.js` | `dev-bundle-integration-testbed.js` |

**`vite.config.server.mjs`** — builds the server-side SSR bundle:

| Entry | Production output | Dev/watch output |
|---|---|---|
| `app/javascript/react-server-side.js` | `bundle-react-server-side.js` | `dev-bundle-react-server-side.js` |
...
- `config/application.rb` — SSR bundle filename updated.
- `config/environments/development.rb` — dev SSR bundle filename updated.
- `config/initializers/assets.rb` — all bundle names added to the Sprockets
  precompile list.
