...
ALTER TABLE meta_context_groups ALTER COLUMN id SET DEFAULT nextval('meta_context_groups_id_seq'::regclass);
...
ALTER TABLE permission_presets ALTER COLUMN id SET DEFAULT nextval('permission_presets_id_seq'::regclass);
